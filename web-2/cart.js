...
function ready() {
    ...
    var addToCartButtons = document.getElementsByClassName('add-butn')
...
function addToCartClicked(event) {
    ...
    var imageSrc = shopItem.getElementsByClassName('prod-img')[0].src
...
function updateCartTotal() {
    ...
    for (var i = 0; i < cartRows.length; i++) {
        ...
        totalqunat =totalqunat+quantity;
        total = total + (price * quantity)
    }
    total = Math.round(total * 100) / 100
    document.getElementsByClassName('cart-total-price')[0].innerText = total+' zł'
    document.getElementsByClassName('cart-total-quantity')[0].innerText = totalqunat
}